    ...
    <div className="font-sans text-gray-900">
      ...
      <main className="p-8">
        ...
        <section className="mb-12 text-center">
          ...
          <button className="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700 transition duration-300 transform hover:scale-105">
            Sign Up
          </button>
          <button className="ml-4 bg-gray-600 text-white px-6 py-2 rounded hover:bg-gray-700 transition duration-300 transform hover:scale-105">
            Log In
          </button>
        </section>
      </main>
