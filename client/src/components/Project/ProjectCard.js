...
const ProjectCard = ({ project }) => {
  return (
    <div className="max-w-sm border-2 border-blue-500 rounded-lg overflow-hidden shadow-lg p-6 m-4 bg-blue-50 transform transition duration-300 hover:scale-105 hover:bg-blue-100">
